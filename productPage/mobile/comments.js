    ...
    >
      ...
      <ProductInfo>
        ...
        >
          <img
            style={{ width: "3.5rem" }}
            src="https://okala.com/_next/image?url=https%3A%2F%2Fcdn.okala.com%2FMedia%2FIndex%2FProduct%2F380841&w=128&q=75"
            alt=""
          />
        </Box>
        <Box>
      ...
      <Commentinfosec>
        <Box>
          <Box ml={2} sx={{ fontSize: ".75rem", display: "inline-block" }}>
            <Image src={chat} />1 کاربر پیشنهاد کرده اند
          </Box>
          <Box sx={{ fontSize: ".75rem", display: "inline-block" }}>
            <Image src={star} />1 کاربر امتیاز داده اند
          </Box>
        </Box>
      </Commentinfosec>
      <RatesInfoSection>
      ...
      <Comment>
        <CommentInformation>
          ...
          <Box className={"leftpart"}>
            ...
            <Date sx={{}}> 12 بهمن 1400</Date>
          </Box>
        </CommentInformation>
        <CommentDiscription>بسیار عالی زیبا جادار و مطمعن</CommentDiscription>
      </Comment>
      <Addtocart>
        <ColorButton
          sx={{
