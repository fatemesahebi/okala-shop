...
const PhoneIcon = createSvgIcon(
    <path
        d="M12 1c-4.97 0-9 4.03-9 9v7c0 1.66 1.34 3 3 3h3v-8H5v-2c0-3.87 3.13-7 7-7s7 3.13 7 7v2h-4v8h4v1h-7v2h6c1.66 0 3-1.34 3-3V10c0-4.97-4.03-9-9-9z"/>, 'Phone');
        ...
        <Box sx={{display: 'flex'}}>
            ...
            <ScrollToShow enable={position === "fixed"}>
                <AppBar position={position} open={open}
                    ...
                    <Toolbar
                        sx={{justifyContent: 'space-between', zIndex: 99, backgroundColor: "white !important"}}>
                        <IconButton
                            color="inherit"
                        ...
                        <Box>
                            <img style={{width: '4rem'}}
                                 src="https://new.okala.com/_next/image?url=%2Fstatic%2Fimages%2Ficons%2Flogo-okala2.svg&w=128&q=75"
                                 alt=""/>
                        </Box>
                        <Button variant="text" disableElevation
                            ...
                            >
                                ...
                                <Grid item>
                                    <Link sx={{color: 'black !important', fontWeight: 'bold'}} mr={1} href="tel:1536"
                                          underline="none">۱۵۳۶</Link>
                                </Grid>
                            </Grid>
                        </Button>
                    </Toolbar>
