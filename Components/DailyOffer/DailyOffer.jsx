    ...
    <Box>
      <Container
        ...
        sx={{
          ...
          backgroundImage:
            "url(https://okala.com/static/images/siteImages/backgrounds/slidersPrimary.svg)",
          alignContent: "center",
          alignItems: "center",
      ...
      >
        ...
        >
          {products.slice(0, 10).map((item, i) => (
            <SingleProduct key={i} product={item} />
          ))}
        </Container>
      </Container>
    </Box>
