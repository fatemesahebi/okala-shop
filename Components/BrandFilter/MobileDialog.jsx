    ...
    <div sx={{ width: "80vw", overflowX: "hidden" }}>
      ...
      >
        ...
        >
          ...
          >
            <Image src={arrow} />
            <FilterMobileDrawer sort={sort} setSort={setSort} />
          </Typography>
      ...
      >
        ...
        <List>
          {(priceFilter[0] !== 0 ||
            ...
            <ListItem button>
              <Stack
                direction="row"
                spacing={1}
                sx={{ padding: "1rem", display: "flex", flexWrap: "wrap" }}
              >
                {priceFilter[0] !== 0 ||
                  (priceFilter[1] !== maxPrice && (
                    <Chip
                ...
                {filterBrand.map((brand, index) => (
                  <Chip
                    key={index}
                    sx={{ marginLeft: ".7rem", marginBottom: ".5rem" }}
                    label={brand}
          ...
          >
            <Typography>
              <MobileCategory categoryName={categoryName} />
            </Typography>
            <Image src={nextIcon} />
          </ListItem>
          <Divider />
          ...
          <ListItem>
            ...
            >
              ...
              >
                <Box>
                  <Box>
                    <Typography component="div"> محدوده قیمت</Typography>
                  </Box>
                </Box>
                <Box>
                  <Button
                    sx={{ color: "midGray.main" }}
                    onClick={() => handleDefaultPrice}
                  >
                    <Typography>مقدار پیش فرض</Typography>
                  </Button>
                </Box>
              </Box>
              <Box
              ...
              <Box>
                ...
                >
                  <MobileDialogInput priceFilter={priceFilter} />
                </Box>
              </Box>
            </div>
          </ListItem>
